    ...
    <div class="container-fluid">
        ...
        <div class="ls-box ls-board-box">
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="ls-box">
                        ...
                        <div class="ls-box-body">
                            <strong>{{number_format ( $conta->saldo_atual , 2 , "," , "." )}}</strong>
                        </div>
            ...
            <div class="ls-actions-btn">
                <a href="/contas/destroy/{{$conta->id}}" class="ls-btn-danger ls-ico-close">Excluir</a>
